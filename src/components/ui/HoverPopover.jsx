  ...
  return (
    ...
    >
      ...
      <div
        id={panelId}
        role="tooltip"
        className={`absolute z-50 liquid-glass rounded-2xl p-4 transition-all duration-200 ${placementClasses[placement]} ${visible ? 'pointer-events-auto opacity-100 scale-100' : 'pointer-events-none opacity-0 scale-95'}`}
