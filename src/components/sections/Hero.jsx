  ...
  return (
    ...
    >
      <ClayCard theme="amber" className="p-8 sm:p-12 text-center" hover={false}>
        <h1
          id="hero-heading"
          className="font-caveat text-4xl sm:text-5xl md:text-6xl font-bold text-slate-900 mb-2"
        >
          {hero.title}
        </h1>
        <p className="text-lg sm:text-xl text-slate-600 mb-6">{hero.subtitle}</p>
